...
public class VerifyConfig {
	 ...
	 * @return
	 */
	public static synchronized Map<String, Object> setUserInfo(HttpServletRequest req, Map<String, Object> ssoUser){
		//TODO do something
...
//		String tokenStr = Tools.isNullOrEmpty(req.getHeader("token")) ? Tools.getReqParamSafe(req, "token") : req.getHeader("token"); //Authorization Basic 
	...
	public static String getSSOUid(HttpServletRequest req){
		String uid = "";
		//token
		String token = getTokenSSO(req);
